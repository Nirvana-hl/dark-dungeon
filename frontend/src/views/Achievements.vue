<template>
  <div class="achievements-page">
    ...
    <header class="page-header">
      <div class="header-content">
        ...
        <div class="stats-summary">
          ...
          <div class="summary-item">
            <span class="summary-number">{{ totalAchievements }}</span>
            <span class="summary-label">总成就</span>
          </div>
          <div class="summary-item">
            <span class="summary-number">{{ completionPercentage }}%</span>
    ...
    <main class="achievements-main">
      ...
      <!-- 空状态 -->
      <div v-else-if="!loading && filteredAchievements.length === 0" class="empty-container">
      ...
      <div v-else class="achievements-grid">
        ...
        >
          <div class="achievement-icon">
            <div class="icon-bg" :class="achievement.rarity">
              <i :class="achievement.icon"></i>
            </div>
            <div v-if="achievement.unlocked" class="unlock-indicator">
              <i class="fas fa-check"></i>
            </div>
            <div v-if="!achievement.unlocked && achievement.progress" class="progress-ring">
          ...
          <div class="achievement-content">
            ...
            <div class="achievement-rewards" v-if="achievement.rewards && achievement.rewards.length > 0">
              <h4>奖励</h4>
              <div class="reward-items">
                ...
                >
                  ...
                  <span>{{ reward.value }} {{ getRewardName(reward.type) }}</span>
                </div>
              </div>
            </div>
      ...
      <div class="achievement-modal" @click.stop>
        ...
        <div class="modal-content">
          <div class="modal-icon">
            <div class="icon-bg large" :class="selectedAchievement.rarity">
          ...
          <div class="modal-info">
            ...
            <div class="modal-stats" v-if="selectedAchievement.stats">
              <div v-for="(stat, key) in selectedAchievement.stats" :key="key" class="stat-row">
