<template>
  ...
  >
    <!-- 稀有度边框 -->
    <div class="rarity-border" :class="`rarity-${offer.rarity}`">
      <!-- 商品图片 -->
      <div class="offer-image">
        ...
        <div v-if="!inStock" class="out-of-stock-overlay">
          <span>缺货</span>
        </div>
      </div>
      ...
      <div class="offer-info">
        <div class="offer-header">
          ...
          <div class="rarity-tag" :class="offer.rarity">
        ...
        <!-- 属性展示（如果是卡牌） -->
        <div v-if="isCard" class="offer-stats">
          <div v-if="cardStats.attack" class="stat">
            <i class="fas fa-sword"></i>
            {{ cardStats.attack }}
          </div>
          <div v-if="cardStats.health" class="stat">
            <i class="fas fa-heart"></i>
            {{ cardStats.health }}
          </div>
          <div v-if="cardStats.actionPointCost" class="stat">
      ...
      <div class="offer-footer">
        <div class="price-section">
          ...
          <div class="current-price">
            <i :class="getCurrencyIcon(offer.currencyType)"></i>
            <span class="price-amount">{{ formatAmount(offer.price) }}</span>
      ...
      <!-- 库存信息 -->
      <div v-if="offer.stock !== undefined" class="stock-info">
        <span class="stock-label">库存:</span>
        <span class="stock-count" :class="{ 'low': offer.stock <= 10 }">
          {{ offer.stock }}
        </span>
      </div>
    </div>
