      ...
      >
        ...
        >
          ...
          <div class="product-info">
            ...
            <div class="product-tags" v-if="offer.tags && offer.tags.length > 0">
              <span v-for="tag in offer.tags" :key="tag" class="product-tag">{{ tag }}</span>
            </div>
          </div>
          <div class="product-purchase">
            <div class="price-section">
              <div class="current-price">
                ...
                <span class="price-value">{{ formatNumber(offer.price || 0) }}</span>
              </div>
            </div>
            <button 
              class="buy-btn"
