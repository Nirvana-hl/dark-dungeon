<template>
  <div class="loading-container" :class="{ 'fullscreen': fullscreen, 'inline': !fullscreen }">
    <div class="loading-content">
      <!-- 加载动画 -->
      <div class="loading-spinner" :class="size">
        <div class="spinner-ring"></div>
        <div v-if="showLogo" class="spinner-logo">
      ...
      <!-- 加载提示 -->
      <div v-if="showTips && currentTip" class="loading-tip">
