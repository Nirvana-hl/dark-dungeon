<template>
  <div class="card-deck-manager">
    ...
    <div class="cards-grid">
      ...
      >
        <div class="card-frame" :class="card.rarity">
          <div class="card-top">
            <span class="mana-cost">{{ card.manaCost || 1 }}</span>
          ...
          <div class="card-bottom">
            ...
            <div class="card-stats-mini" v-if="card.cardType === 'character'">
        ...
        <div v-if="isCardEquipped(card.id)" class="equipped-overlay">
