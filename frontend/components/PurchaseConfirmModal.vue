      ...
      <main class="modal-content">
        ...
        <view class="purchase-item">
          ...
          <view class="item-details">
            ...
            <view class="item-meta">
              ...
              <text class="rarity" :class="offer.rarity">
        ...
        <view class="price-breakdown">
          ...
          <view class="price-row total">
            ...
            <text class="price-value total-amount">
              <i :class="getCurrencyIcon(offer.currencyType)"></i>
        ...
        <!-- 余额信息 -->
        <view class="balance-section" :class="{ 'insufficient': !hasEnoughBalance }">
          <h3>账户余额</h3>
          ...
          <view class="balance-row remaining">
            <text class="balance-label">购买后余额:</text>
            <text class="balance-amount" :class="{ 'negative': remainingBalance < 0 }">
              <i :class="getCurrencyIcon(offer.currencyType)"></i>
        ...
        <!-- 警告信息 -->
        <view v-if="!hasEnoughBalance" class="warning-section">
