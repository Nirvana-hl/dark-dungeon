<template>
    <Transition name="class-fade">
      <view v-if="show" class="class-overlay" @click.self="handleClose">
        <view class="class-container">
          <view class="class-header">
            <text class="class-title">选择你的职业</text>
            <text class="class-subtitle">每个职业都有独特的技能和战斗风格</text>
          </view>

          <view v-if="loading" class="class-loading">
            <view class="loading-spinner"></view>
            <text>加载职业信息中...</text>
          </view>

          <view v-else-if="error" class="class-error">
            <text>{{ error }}</text>
          ...
          <view v-else class="class-grid">
            ...
            >
              <view class="class-icon">{{ getClassIcon(classItem.code) }}</view>
              <view class="class-name">{{ classItem.name }}</view>
              <view class="class-description">{{ getClassDescription(classItem.code) }}</view>
              <view class="class-stats">
                <view class="stat-item">
                  <text class="stat-label">基础HP:</text>
                  <text class="stat-value">{{ classItem.baseHp }}</text>
                </view>
                <view class="stat-item">
                  <text class="stat-label">每级HP:</text>
                  <text class="stat-value">+{{ classItem.hpPerLevel }}</text>
                </view>
              </view>
            </view>
          </view>
