<template>
  <view class="ai-assistant" :class="{ 'expanded': isExpanded, 'minimized': isMinimized }">
    <!-- AI助手头部 -->
    ...
    <!-- 展开的内容区域 -->
    <view v-if="isExpanded && !isMinimized" class="assistant-content">
      <!-- 快捷建议 -->
        ...
        <view class="chat-messages" ref="messagesContainer">
          ...
          >
            ...
            <view class="message-content">
              <view class="message-text" v-html="formatMessage(message.content)"></view>
      ...
      <!-- 分析面板 -->
      <view class="analysis-panel" v-if="showAnalysis">
        <h4>游戏分析</h4>
        <view class="analysis-grid">
          <view class="analysis-item">
            <view class="analysis-label">胜率分析</view>
            <view class="analysis-value" :class="getAnalysisClass(gameData.winRate)">
              {{ (gameData.winRate * 100).toFixed(1) }}%
            </view>
          </view>
          <view class="analysis-item">
            <view class="analysis-label">平均回合数</view>
            <view class="analysis-value">{{ gameData.avgRounds }}</view>
          </view>
          <view class="analysis-item">
            <view class="analysis-label">卡牌使用率</view>
            <view class="analysis-value">{{ (gameData.cardUsage * 100).toFixed(1) }}%</view>
          </view>
          <view class="analysis-item">
            <view class="analysis-label">压力管理</view>
            <view class="analysis-value" :class="getAnalysisClass(gameData.stressManagement)">
