    ...
    <view class="status-content">
      ...
      <view class="character-info">
        ...
        <view class="character-details">
          <view class="character-name">冒险者</view>
          <view class="character-level">等级 5</view>
        </view>
      </view>

      <!-- 中间：状态条 -->
      <view class="status-meters">
        <!-- 生命值条 -->
        <view class="meter-item hp-meter">
          <view class="meter-label">
            <text class="label-icon">❤️</text>
            <text class="label-text">生命值</text>
          </view>
          <view class="meter-bar-container">
            <view class="meter-bar-bg">
              <view 
            ...
            <view class="meter-value">
              <text class="value-current">{{ heroHP }}</text>
              <text class="value-separator">/</text>
              <text class="value-max">{{ heroHPMax }}</text>
            </view>
          </view>
        </view>

        <!-- 法力值条 -->
        <view class="meter-item mana-meter">
          <view class="meter-label">
            <text class="label-icon">💎</text>
            <text class="label-text">法力值</text>
          </view>
          <view class="meter-bar-container">
            <view class="meter-bar-bg">
              <view 
            ...
            <view class="meter-value">
              <text class="value-current">{{ mana }}</text>
              <text class="value-separator">/</text>
              <text class="value-max">{{ manaMax }}</text>
            </view>
          </view>
        </view>
      </view>
      ...
      <!-- 右侧：回合指示器 -->
      <view class="turn-indicator" :class="{ 'player-turn': turn === 'player', 'opponent-turn': turn === 'opponent' }">
        <view class="turn-icon-wrapper">
          <text class="turn-icon">{{ turn === 'player' ? '⚡' : '⏸️' }}</text>
        </view>
        <view class="turn-text">
          <text class="turn-label">{{ turn === 'player' ? '你的回合' : '对手回合' }}</text>
        </view>
      </view>
    </view>
  </header>
