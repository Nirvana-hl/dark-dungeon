<template>
  ...
  >
    <view class="card-header">
      ...
      <text v-if="rarity" :class="['rarity-tag', `rarity-${rarity}`]">
        {{ rarityDisplay }}
      </text>
    </view>
    ...
    <view class="card-content">
      <slot name="content">
        <view v-if="imageUrl" class="card-image">
          <image :src="imageUrl" :alt="name" />
        </view>
        <view v-if="description" class="card-description">
          {{ description }}
        </view>
      </slot>
    </view>
    
    <view v-if="showStats" class="card-stats">
      <view v-if="hp" class="stat-item">
        <text class="stat-label">HP:</text>
        <text class="stat-value">{{ hp }}</text>
      </view>
      <view v-if="attack" class="stat-item">
        <text class="stat-label">ATK:</text>
        <text class="stat-value">{{ attack }}</text>
      </view>
      <view v-if="actionPoints" class="stat-item">
        <text class="stat-label">AP:</text>
        <text class="stat-value">{{ actionPoints }}</text>
      </view>
      <view v-if="stars" class="stat-item stars">
    ...
    <!-- 工具提示 -->
    <view v-if="tooltip && showTooltip" class="tooltip-content">
      {{ tooltip }}
    </view>
  </view>
</template>
